...
const CommentTile = (props: {
	...
	return (
		...
		>
			<div className={`relative p-8 md:p-10 mx-auto max-w-3xl h-[480px] md:h-[520px] flex flex-col justify-center rounded-2xl border transition-all duration-[10ms] overflow-hidden ${props.isActive
