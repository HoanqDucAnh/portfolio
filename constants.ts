...
export const TIMELINE: Array<TimelineNodeV2> = [
	...
	{
		type: NodeTypes.CHECKPOINT,
		title: "Technical Admin Team - <a class='underline underline-offset-2' href='https://xomdata.com' target='_blank' rel='noopener noreferrer'><u>Xóm Data</u></a>",
		size: ItemSize.SMALL,
		subtitle: "Vietnam's largest data community · 110,000+ members",
		location: "Remote",
		image: "/timeline/xomdata.webp",
		slideImage: "/timeline/xomdata.webp",
		shouldDrawLine: true,
		alignment: Branch.LEFT,
		companyLogo: "/timeline/xomdata.webp",
		companyUrl: "https://xomdata.com",
		techStack: [
			{ name: "dbt", icon: "/skills/1st/dbt.svg" },
			{ name: "Python", icon: "/projects/tech/python.svg" },
			{ name: "PostgreSQL", icon: "/projects/tech/PostgreSQL.svg" },
			{ name: "Snowflake", icon: "/skills/1st/Snowflake.svg" },
			{ name: "GitHub", icon: "/skills/1st/Github.svg" },
		],
	},
	{
		type: NodeTypes.CHECKPOINT,
	...
	{
		type: NodeTypes.CHECKPOINT,
		title: "Technical Writer - <a class='underline underline-offset-2' href='https://vutr.substack.com/' target='_blank' rel='noopener noreferrer'><u>vutr</u></a>",
		size: ItemSize.SMALL,
		subtitle: "Data engineering newsletter · 19,000+ engineers",
		location: "Remote",
		image: "/timeline/vutr.webp",
		slideImage: "/timeline/vutr.webp",
		shouldDrawLine: true,
		alignment: Branch.LEFT,
		companyLogo: "/timeline/vutr.webp",
		companyUrl: "https://vutr.substack.com/",
		techStack: [
			{ name: "Python", icon: "/projects/tech/python.svg" },
			{ name: "dbt", icon: "/skills/1st/dbt.svg" },
			{ name: "Airflow", icon: "/skills/1st/Apache Airflow.svg" },
			...
			{ name: "Docker", icon: "/skills/1st/Docker.svg" },
		],
	},
	{
		type: NodeTypes.CHECKPOINT,
