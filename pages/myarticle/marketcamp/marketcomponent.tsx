...
export default function MarketComponent() {
	return (
		<div className="grid grid-cols-5 mt-24 ">
			<div className="col-span-1 section-container min-h-screen mb-24"></div>
			<div className="col-span-3 section-container min-h-screen mb-24 text-center">
				<h1 className="text-4xl text-[#f27d0d]">Marketing Campaign Success</h1>
				...
				<div className="text-xs m-5 text-justify">
					<div className="mb-5">
						...
						by user. Users who make their first in-app purchase are placed in a
						marketing campaign where they see call-to-actions for more in-app
						purchases. Find the number of users that made additional in-app
					...
					<div className="mb-5">
						<ul style={{ listStyleType: "circle" }}>
							The <code>marketing_campaign</code> table contains the following
							columns:
							...
							<li style={{ marginLeft: "2rem" }} className="mb-1">
								<code>product_id:</code> The unique identifier for each in-app
								product.
							</li>
							<li style={{ marginLeft: "2rem" }} className="mb-1">
					...
					<div className="mb-2">
						<p className="text-xl mt-2 text-[#f27d0d]">The Problem Statement</p>
					</div>
					<div className="mb-5">
						<ol style={{ listStyleType: "decimal" }}>
							...
							there are a few conditions that need to be met for a user to be
							considered to have made additional in-app purchases:
							<li style={{ marginLeft: "2rem" }} className="m-1">
							...
							<li style={{ marginLeft: "2rem" }} className="mb-1">
								Users who only made one or multiple purchases on the first day
								do not count.
							</li>
							<li style={{ marginLeft: "2rem" }} className="mb-1">
								Users who over time purchase only the products they purchased on
								the first day do not count.
							</li>
						</ol>
						<p>
					...
					<div className="mb-2">
						<p className="mb-2">
							Users that only made one or multiple purchases on the first day do
							not count. Let's find the list of users who only purchase for one
							day.
						</p>
						<div className="mb-2">
					...
					<div className="mb-2">
						<p>
							Alright, now we have to determine each user's 'first day'. We will
							accomplish this by creating a ranking column as follows using
					...
					<div className="mb-2">
						<p>
							...
							(first-day purchase), where cte1.ranking = 1. The result will be a
							list of product that each user_id buy on their first-day purchase
						</p>
					</div>
					<div className="mb-2">
					...
					<div className="mb-2">
						<p>
							We will perform a left join on the others CTE and the first CTE.
							The idea is to see if there’s any user who only purchase the
							first-day product.
						</p>
					</div>
					<div className="mb-2">
					...
					<div className="mb-2">
						<p>
							We can see that a couple of users there are a couple of users that
							only purchase the first-day product. Let’s remove these usersthese
							user by using the IS NULL function on the first_day_purchase.
							After that, we can use the COUNT(Distinct) function to count the
							number of users that made additional in-app purchases due to the
					...
					<div className="mb-2">
						<p>
							Let’s think of another more readable solution thatsolution that is
							more readable and does not have to use the join statement.
						</p>
					</div>
					<div className="mb-2">
